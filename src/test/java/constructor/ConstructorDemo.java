...
//		* So, when we create object for child class, firstly, child class default constructor will be called, but within child class constrctor, super() is implicitly present,
